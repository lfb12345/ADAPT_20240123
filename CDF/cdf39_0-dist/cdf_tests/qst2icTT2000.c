...
double year1=2016.0, month1=12.0, day1=31.0, hour1=23.0, minute1=59.0,
       second1=57.0, msec1=100.0, usec1=200.0, nsec1=300.0;
double year=2016.0, month=12.0, day=31.0, hour=23.0, minute=59.0, second=57.0, 
       msec=100.0, usec=200.0, nsec=300.0;
...
printf ("Base 1: 2000-01-01T12:00.00.000 => %lld nanoseconds\n", tt2000[0]);
/* encodeTT2000 (tt2000[0], string, 3); */
toEncodeTT2000 (tt2000[0], 3, string);
printf ("        %lld => %s\n", tt2000[0], string);

breakdownTT2000 (0LL, &yearOut, &monthOut, &dayOut, &hourOut, &minuteOut,
                 &secondOut, &msecOut, &usecOut, &nsecOut);

printf ("Base 2: 0 nanoseconds => %ld-%ld-%ldT%ld:%ld.%ld.%3.3ld%3.3ld%3.3ld\n",
         (long)yearOut, (long)monthOut, (long)dayOut, (long)hourOut,
         (long)minuteOut, (long)secondOut, (long)msecOut, (long)usecOut,
         (long)nsecOut);
tt2000[0] = computeTT2000 (yearOut, monthOut, dayOut, hourOut, minuteOut,
                           secondOut, msecOut, usecOut, nsecOut);
toEncodeTT2000 (tt2000[0], 3, string);
printf ("        %s => %lld\n", string, tt2000[0]);
