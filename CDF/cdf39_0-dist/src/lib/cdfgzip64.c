...
static int defgzip(vFILE *src, vFILE *dst, OFF_T iSize, OFF_T *osize,
		   int level);
...
STATICforIDL CDFstatus CompressGZIP_64 (srcFp, srcOffset, srcSize,
					srcError, destFp, destOffset,
					destSize, destError, level)
vFILE *srcFp;
OFF_T srcOffset;
OFF_T srcSize;
CDFstatus srcError;
...
STATICforIDL CDFstatus DecompressGZIP_64 (srcFp, srcOffset, iSize,
					  srcError, destFp, destOffset,
					  destError)
vFILE *srcFp;
OFF_T srcOffset;
