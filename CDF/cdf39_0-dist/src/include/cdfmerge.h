...
Logical LoadMastergAttributes (CDFid, CDFid, long);
Logical LoadMasterVariables (CDFid, CDFid, long, long, long);
Logical LoadVariableData(int, CDFid);
