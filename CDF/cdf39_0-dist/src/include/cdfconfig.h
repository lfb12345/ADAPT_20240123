...
#  define NUMcacheSTAGE		18000
#  define NUMcacheCOMPRESS	200000
#endif
...
/*****************************************************************************
* Blocking factors - used for variable blocking factor.
* -- standard: non-compressed and non-sparse-record variabale
*              used for allocating a new block when adding record(s)
* -- sparse: sparse-record variabale
* -- compressed: compressed variable
*****************************************************************************/
#if defined(win32)
...
*****************************************************************************/
    ...
    defined(ia64vmsD) || defined(ia64vmsG)
...
#define DEFAULTnetworkEXPORT            FALSE   /* TRUE = "network",
						   FALSE = "host". */
#define DEFAULTepochEXPORT              4       /* 0 (standard), 1, 2, 3, 4. */
#define DEFAULTstyleEXPORT              6       /* For CDF_EPOCH/CDF_EPOCH16.
                                                   Style value: 0, 1, 2, 3, 4 
                                                   (C/Fortran format), 5
                                                   (custom format), or 6
                                                   (ISO 8601). */
#define DEFAULTtt2000EXPORT             0       /* 0, 1, 2, 3 (ISO 8601). */
...
#define DEFAULTformatSIMPLE		FALSE
...
#define DEFAULTepochSIMPLE		6
#define DEFAULTtt2000SIMPLE		3
...
#define DEFAULTstyleEDIT        6               /* EPOCH4_STYLE */
                                                /* For CDF_EPOCH and
                                                   CDF_EPOCH16. Value: 0, 1,
                                                   2, 3, 4 (C/Fortran format),
                                                   5, (custom format), or 6
                                                   (ISO 8601). */
...
#define DEFAULTstyleINQ         6               /* EPOCH4_STYLE */
...
#define DEFAULTstyleIRsDUMP	   6	        /* EPOCH4_STYLE. */
...
#define DEFAULTdataCMP          TRUE            /* [no]data */
...
#define DEFAULTstyleCMP         6               /* EPOCH4_STYLE */
...
#define DEFAULTzModeSTATS       zMODEoff        /* zMODEoff = zMode/0,
						   zMODEon1 = zMode/1,
						   zMODEon2 = zMode/2 */
#define DEFAULTstyleSTATS       6               /* EPOCH4_STYLE */
...
#define DEFAULTstyleCDF2SKT	0		/* EPOCH0_STYLE */
...
#define DEFAULTstyleDUMP        6               /* EPOCH4_STYLE */
