...
#define FREECACHESv64(fp) (V_freecaches64(fp))
/******************************************************************************
* LoadCVVRx/LoadVVRx.
******************************************************************************/
...
struct AEDRstruct64 {
  ...
  Int32 NumStrings;     /* Number of strings of string type */
  Int32 rfuB;           /* reserved for future use (value = 0) */
  Int32 rfuC;           /* reserved for future use (value = 0) */
  Int32 rfuD;           /* reserved for future use (value = -1) */
  Int32 rfuE;           /* reserved for future use (value = -1) */
...
#define AEDR_NUMSTRINGS_OFFSET64 36
...
STATICforIDL CDFstatus DecompressCDF64 PROTOARGs((struct CDFstruct *CDF, vFILE *dotFp, vFILE *uDotFp));
...
STATICforIDL CDFstatus InitVarStage64 PROTOARGs((
  struct CDFstruct *CDF, struct VarStruct *Var, OFF_T nBytes
));
...
STATICforIDL CDFstatus Compress64 PROTOARGs((
  struct CDFstruct *CDF, vFILE *iFp, OFF_T iOffset, OFF_T iSize, 
  CDFstatus iError, Int32 cType, Int32 cParms[], vFILE *oFp, OFF_T oOffset,
  OFF_T *oSize, CDFstatus oError
));
STATICforIDL CDFstatus Decompress64 PROTOARGs((
  struct CDFstruct *CDF, vFILE *iFp, OFF_T iOffset, OFF_T iSize, CDFstatus iError, Int32 cType,
...
#endif
VISIBLE_PREFIX CDFstatus FlushAllVarStages64 PROTOARGs((
  struct CDFstruct *CDF, struct VarStruct *Var
));
VISIBLE_PREFIX Logical CheckForOverCaches64 PROTOARGs((
  struct CDFstruct *CDF, struct VarStruct *Var
));
...
VISIBLE_PREFIX void V_freecaches64 PROTOARGs((vFILE *vFp));
