...
*   V3.15 10-Apr-21, M Liu      Added a few functions to handle UTF-8 encoding
*                               characters.
******************************************************************************/
...
#define CDFputAttrStrgEntry(id,attrNum,entryNum,string) \
CDFputAttrStrEntry(id,1,attrNum,entryNum,string)
#define CDFputAttrStrrEntry(id,attrNum,entryNum,string) \
CDFputAttrStrEntry(id,2,attrNum,entryNum,string)
#define CDFputAttrStrzEntry(id,attrNum,entryNum,string) \
CDFputAttrStrEntry(id,3,attrNum,entryNum,string)

#define CDFputAttrWStrgEntry(id,attrNum,entryNum,string,locale) \
CDFputAttrWStrEntry(id,1,attrNum,entryNum,string,locale)
#define CDFputAttrWStrrEntry(id,attrNum,entryNum,string,locale) \
CDFputAttrWStrEntry(id,2,attrNum,entryNum,string,locale)
#define CDFputAttrWStrzEntry(id,attrNum,entryNum,string,locale) \
CDFputAttrWStrEntry(id,3,attrNum,entryNum,string,locale)
...
#define CDFreadAttrStrgEntry CDFgetAttrStrgEntry 
#define CDFreadAttrStrrEntry CDFgetAttrStrrEntry 
#define CDFreadAttrStrzEntry CDFgetAttrStrzEntry 
#define CDFreadAttrStrEntry CDFgetAttrStrEntry 
#define CDFgetAttrStrgEntry(id,attrNum,entryNum,string) \
CDFgetAttrStrEntry(id,1,attrNum,entryNum,string)
#define CDFgetAttrStrrEntry(id,attrNum,entryNum,string) \
CDFgetAttrStrEntry(id,2,attrNum,entryNum,string)
#define CDFgetAttrStrzEntry(id,attrNum,entryNum,string) \
CDFgetAttrStrEntry(id,3,attrNum,entryNum,string)

#define CDFgetAttrWStrgEntry(id,attrNum,entryNum,string,locale) \
CDFgetAttrWStrEntry(id,1,attrNum,entryNum,string,locale)
#define CDFgetAttrWStrrEntry(id,attrNum,entryNum,string,locale) \
CDFgetAttrWStrEntry(id,2,attrNum,entryNum,string,locale)
#define CDFgetAttrWStrzEntry(id,attrNum,entryNum,string,locale) \
CDFgetAttrWStrEntry(id,3,attrNum,entryNum,string,locale)

#define CDFreadAttrrEntryStrings CDFgetAttrrEntryStrings
#define CDFreadAttrzEntryStrings CDFgetAttrzEntryStrings
#define CDFreadAttrEntryStrings CDFgetAttrEntryStrings
#define CDFgetAttrrEntryStrings(id,attrNum,entryNum,numStrings,strings) \
CDFgetAttrEntryStrings(id,0,attrNum,entryNum,numStrings,strings)
#define CDFgetAttrzEntryStrings(id,attrNum,entryNum,numStrings,strings) \
CDFgetAttrEntryStrings(id,1,attrNum,entryNum,numStrings,strings)

#define CDFreadgAttrEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,0,attrNum,entryNum,dataType,numElms,value)
#define CDFreadAttrgEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,0,attrNum,entryNum,dataType,numElms,value)
#define CDFreadrAttrEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,1,attrNum,entryNum,dataType,numElms,value)
#define CDFreadAttrrEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,1,attrNum,entryNum,dataType,numElms,value)
#define CDFreadzAttrEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,2,attrNum,entryNum,dataType,numElms,value)
#define CDFreadAttrzEntry(id,attrNum,entryNum,dataType,numElms,value) \
CDFreadAttrEntry(id,2,attrNum,entryNum,dataType,numElms,value)

#define CDFputAttrrEntryStrings(id,attrNum,entryNum,numStrings,strings) \
CDFputAttrEntryStrings(id,0,attrNum,entryNum,numStrings,strings)
#define CDFputAttrzEntryStrings(id,attrNum,entryNum,numStrings,strings) \
CDFputAttrEntryStrings(id,1,attrNum,entryNum,numStrings,strings)
...
#define CDFgetAttrrEntryNumStrings(id,attrNum,entryNum,numStrings) \
CDFgetAttrEntryNumStrings(id,0,attrNum,entryNum,numStrings)
#define CDFgetAttrzEntryNumStrings(id,attrNum,entryNum,numStrings) \
CDFgetAttrEntryNumStrings(id,1,attrNum,entryNum,numStrings)
...
#define CDFdeleterVarRecordsRenumber(id,varNum,sRec,eRec) \
CDFdeleteVarRecordsRenumber(id,0,varNum,sRec,eRec)
...
#define CDFgetVarsRecordDatabyVarNames CDFgetVarsRecordDatabyNames
#define CDFputVarsRecordDatabyVarNums CDFputVarsRecordDatabyNums

#define CDFgetrVarsRecordDatabyNums(id,numVars,varNums,recNum,bufferPtrs) \
CDFgetVarsRecordDatabyNums(id,0,numVars,varNums,recNum,bufferPtrs)
#define CDFgetzVarsRecordDatabyNums(id,numVars,varNums,recNum,bufferPtrs) \
CDFgetVarsRecordDatabyNums(id,1,numVars,varNums,recNum,bufferPtrs)

#define CDFputrVarsRecordDatabyNums(id,numVars,varNums,recNum,bufferPtrs) \
CDFputVarsRecordDatabyNums(id,0,numVars,varNums,recNum,bufferPtrs)
#define CDFputzVarsRecordDatabyNums(id,numVars,varNums,recNum,bufferPtrs) \
CDFputVarsRecordDatabyNums(id,1,numVars,varNums,recNum,bufferPtrs)

#define CDFgetrVarsRecordData(id,numVars,varNames,recNum,bufferPtrs) \
CDFgetVarsRecordDatabyNames(id,0,numVars,varNames,recNum,bufferPtrs)
#define CDFgetzVarsRecordData(id,numVars,varNames,recNum,bufferPtrs) \
CDFgetVarsRecordDatabyNames(id,1,numVars,varNames,recNum,bufferPtrs)

#define CDFputrVarsRecordData(id,numVars,varNames,recNum,bufferPtrs) \
CDFputVarsRecordDatabyNames(id,0,numVars,varNames,recNum,bufferPtrs)
#define CDFputzVarsRecordData(id,numVars,varNames,recNum,bufferPtrs) \
CDFputVarsRecordDatabyNames(id,1,numVars,varNames,recNum,bufferPtrs)
...
#define CDFgetzVarAllRecordsbyVarNum CDFgetzVarAllRecordsByVarID
#define CDFgetrVarAllRecordsByVarID(id,varNum,buffer) \
CDFgetVarAllRecordsByVarID(id,0,varNum,buffer)
#define CDFgetzVarAllRecordsByVarID(id,varNum,buffer) \
CDFgetVarAllRecordsByVarID(id,1,varNum,buffer)

#define CDFputzVarAllRecordsbyVarNum CDFputzVarAllRecordsByVarID
#define CDFputrVarAllRecordsByVarID(id,varNum,numRecs,buffer) \
CDFputVarAllRecordsByVarID(id,0,varNum,numRecs,buffer)
#define CDFputzVarAllRecordsByVarID(id,varNum,numRecs,buffer) \
CDFputVarAllRecordsByVarID(id,1,varNum,numRecs,buffer)

#define CDFgetrVarRangeRecordsByVarID(id,varNum,startRec,stopRec,buffer) \
CDFgetVarRangeRecordsByVarID(id,0,varNum,startRec,stopRec,buffer)
...
#define CDFputrVarRangeRecordsByVarID(id,varNum,startRec,stopRec,buffer) \
CDFputVarRangeRecordsByVarID(id,0,varNum,startRec,stopRec,buffer)
...
#define CDF_Free_Strings CDF_Free_String
...
VISIBLE_PREFIX CDFstatus CDFputAttrStrEntry PROTOARGs((
...
VISIBLE_PREFIX CDFstatus CDFgetAttrWStrEntry PROTOARGs((
  CDFid id, int grzEntry, long attrNum, long entryNum, wchar_t **wstring,
  char *locale
));
/* #endif */
...
VISIBLE_PREFIX CDFstatus CDFreadAttrEntry PROTOARGs((
  CDFid id, int grzEntry, long attrNum, long entryNum, long *dataType,
  long *numElms, CDFdata *value
));
...
VISIBLE_PREFIX CDFstatus CDFgetVarsRecordDatabyNums PROTOARGs((
  CDFid id, int zVar, long numVars, long varNums[], long recNum,
  void *buffers[]
));
...
VISIBLE_PREFIX CDFstatus CDFputVarsRecordDatabyNums PROTOARGs((
  CDFid id, int zVar, long numVars, long varNums[], long recNum,
  void *buffers[]
));
...
VISIBLE_PREFIX void StringBreakIntoStrings PROTOARGs((
char *string, long numElms, long numStrs, char ***strings
));
...
VISIBLE_PREFIX void EPOCHtoUnixTime PROTOARGs((
  double *epoch,
  double *unitTime,
  int    numTimes
));
VISIBLE_PREFIX void UnixTimetoEPOCH PROTOARGs((
  double *unitTime,
  double *epoch,
  int    numTimes
));
...
VISIBLE_PREFIX void EPOCH16toUnixTime PROTOARGs((
  double *epoch,
  double *unixTime,
  int    numTimes
));
VISIBLE_PREFIX void UnixTimetoEPOCH16 PROTOARGs((
  double *unixTime,
  double *epoch,
  int    numTimes
));
...
VISIBLE_PREFIX int UTF8StrCharsFromCharAt PROTOARGs((const char *, int));
...
VISIBLE_PREFIX void TT2000toUnixTime PROTOARGs((
  long long *epoch,
  double *unixTime,
  int    numTimes
));
VISIBLE_PREFIX void UnixTimetoTT2000 PROTOARGs((
  double *unixTime,
  long long *epoch,
  int    numTimes
));
...
#endif
VISIBLE_PREFIX void CDF_Free_String PROTOARGs((
  long numStrings, char **strings
));
VISIBLE_PREFIX long FindNumberOfItems PROTOARGs((
  char *string, long numElems, char *delimiter
));
#if defined(__cplusplus)
}
#endif
