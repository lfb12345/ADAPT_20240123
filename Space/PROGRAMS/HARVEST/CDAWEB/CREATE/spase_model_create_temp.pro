...
help,resource_header,/structure
...
if keyword_set(keyword_spatial_description) and not keyword_set(keyword_required) then model=create_struct(name='Model','resource_id','','resource_header',resource_header,'access_information_optional',replicate(access_information_optional,spase_ontology(1342).occur_num),'versions',versions,'model_type','','code_language','','temporal_dependence','','spatial_description',spatial_description,'modeled_region',make_array(spase_ontology(1386).occur_num,/string,value=''),'input_properties',input_properties,'output_parameters',output_parameters,'model_url','')

if keyword_set(keyword_spatial_description) and keyword_set(keyword_required) then model=create_struct(name='Model','resource_id','','resource_header',resource_header,'model_type','')
