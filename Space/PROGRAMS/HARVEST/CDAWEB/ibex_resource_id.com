...
#DAWEB_ID_LIST=`grep ^ibex_ vcdawebo.tab | awk 'BEGIN { FS="	" } ; { print $1 }'`

CDAWEB_ID_LIST=`awk '{ print $2 }' cdaweb_harvest_wrapper_all.com`
...
do
    ...
    DATE_STYLE=`grep ^'cdaweb_harvest_wrapper.com '$CDAWEB_ID' ' cdaweb_harvest_wrapper_all.com | awk '{ print $3 }'`

    echo $CDAWEB_ID'	'$DATE_STYLE'	'$SPASE_RESOURCE_ID
